import { sleeveTransform } from "../handling/sleeves.mjs";

export function getAttribute(type, mainElement, action) {
    let reply = ""
    ...
    if(element){
        ...
        if (type === "child") {
            // const children = element.options.map(childElement => childElement);
            reply=element.options
